...
<body>
    <div class="container">
        ...
        <form action="{{ route('courses.update', $course->courseID) }}" method="POST">
            ...
            <input type="text" id="courseID" name="courseID" value="{{ $course->courseID }}" readonly>
            ...
            <input type="text" id="courseClassroom" name="courseClassroom" value="{{ $course->courseClassroom }}" required>

            <label for="courseTime">Course Time:</label>
            <input type="datetime-local" id="courseTime" name="courseTime" value="{{ $course->courseTime->format('Y-m-d\TH:i') }}" required>

            <label for="lecturerID">Lecturer ID:</label>
            <input type="text" id="lecturerID" name="lecturerID" value="{{ $course->lecturerID }}" required>

            <label for="lecturerName">Lecturer Name:</label>
            <input type="text" id="lecturerName" name="lecturerName" value="{{ $course->lecturerName }}" required>
